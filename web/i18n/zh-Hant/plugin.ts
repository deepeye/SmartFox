const translation = {
  ...
  marketplace: {
    ...
    sortBy: '排序方式',
    viewMore: '查看更多',
    SmartfoxMarketplace: 'Smartfox 市場',
    pluginsResult: '{{num}} 個結果',
    verifiedTip: '由 Smartfox 驗證',
    partnerTip: '由 Smartfox 合作夥伴驗證',
  },
  task: {
  ...
  SmartfoxVersionNotCompatible: '當前的 Smartfox 版本與此插件不兼容，請升級至所需的最低版本：{{minimalSmartfoxVersion}}',
  auth: {
    setDefault: '設置為默認',
    useOAuth: '使用 OAuth',
    saveAndAuth: '保存並授權',
