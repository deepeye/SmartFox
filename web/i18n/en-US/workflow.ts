  ...
  nodes: {
    ...
    llm: {
      ...
      jsonSchema: {
        ...
        resultTip: 'Here is the generated result. If you\'re not satisfied, you can go back and moSmartfox your prompt.',
        back: 'Back',
    ...
    knowledgeBase: {
      ...
      chunkStructureTip: {
        ...
        message: 'The Smartfox Knowledge Base supports three chunking structures: General, Parent-child, and Q&A. Each knowledge base can have only one structure. The output from the preceding node must align with the selected chunk structure. Note that the choice of chunking structure affects the available index methods.',
        learnMore: 'Learn more',
      },
