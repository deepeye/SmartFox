const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of Smartfox and retrieve knowledge from that knowledge base.',
  ...
  intro1: 'The Knowledge can be integrated into the Smartfox application ',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
  ...
  metadata: {
    ...
    documentMetadata: {
      metadataToolTip: 'Metadata serves as a critical filter that enhances the accuracy and relevance of information retrieval. You can moSmartfox and add metadata for this document here.',
