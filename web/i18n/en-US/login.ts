const translation = {
  ...
  welcome: '👋 Welcome to Smartfox, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Smartfox Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Smartfox',
  invalid: 'The link has expired',
  explore: 'Explore Smartfox',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Smartfox and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Smartfox Enterprise license for your workspace has expired. Please contact your administrator to continue using Smartfox.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Smartfox license server. Please contact your administrator to continue using Smartfox.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Smartfox Enterprise license for your workspace is inactive. Please contact your administrator to continue using Smartfox.',
  webapp: {
    login: 'Login',
