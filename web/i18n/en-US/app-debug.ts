const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you moSmartfox the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'MoSmartfoxing the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'MoSmartfoxing the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
