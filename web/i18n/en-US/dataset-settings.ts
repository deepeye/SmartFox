const translation = {
  ...
  desc: 'Here you can moSmartfox the properties and retrieval settings of this Knowledge.',
  form: {
    name: 'Knowledge Name',
    ...
    descPlaceholder: 'Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, Smartfox will use the default hit strategy.',
