const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Smartfox to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Smartfox allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Smartfox\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Smartfox {{version}} is now available.',
    latestAvailable: 'Smartfox {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
