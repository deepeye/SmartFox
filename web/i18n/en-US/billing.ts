const translation = {
  ...
  plansCommon: {
    ...
    unlimitedApiRate: 'No Smartfox API Rate Limit',
    apiRateLimitTooltip: 'API Rate Limit applies to all requests made through the Smartfox API, including text generation, chat conversations, workflow executions, and document processing.',
    ...
    messageRequest: {
      ...
      tooltip: 'Message credits are provided to help you easily try out different OpenAI models in Smartfox. Credits are consumed based on the model type. Once they’re used up, you can switch to your own OpenAI API key.',
    },
    annotatedResponse: {
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of Smartfox.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with Smartfox Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by Smartfox Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by Smartfox Officially',
